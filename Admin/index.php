...
<main role="main" class="container">
	...
	<h1 class="mt-5">Listado tareas pendientes</h1>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
	...
	<li class='page-item <?php if ($pagina==$i){ echo "active"; }?>'><a class='page-link' href='index.php?pagina=<?php  echo $i ?>'><?php  echo $i; ?></a></li>
